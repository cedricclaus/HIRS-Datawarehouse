package be.fgov.famhp.hirs.datawarehouse.repository;

import static be.fgov.famhp.hirs.datawarehouse.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
import static org.assertj.core.api.Assertions.assertThat;

import be.fgov.famhp.hirs.datawarehouse.HirsDatawarehouseApp;
import be.fgov.famhp.hirs.datawarehouse.config.Constants;
import be.fgov.famhp.hirs.datawarehouse.config.TestSecurityConfiguration;
import be.fgov.famhp.hirs.datawarehouse.config.audit.AuditEventConverter;
import be.fgov.famhp.hirs.datawarehouse.domain.PersistentAuditEvent;
